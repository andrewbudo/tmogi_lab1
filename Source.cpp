...
{
    ifstream heights_file("Var30_heights.txt");
    string benchmark_name;
    double height;
...
void ImportMeasurements(vector<Meas>& sections)
{
    ifstream measurements_file("Var30_measurements.txt");
    string from_station;
    string to_station;
    double elevation;
    double distance;
...
void GetResiduals(vector<Point>& points, vector<Meas>& sections)
{
    ...
    double w2 = sections[2].elevation - sections[6].elevation - sections[5].elevation;
    double w3 = sections[3].elevation + sections[7].elevation + sections[6].elevation;
    double w4 = sections[0].elevation + sections[1].elevation + sections[2].elevation 
        + sections[3].elevation - (points[1].height - points[0].height);
